...
<table border='0' id='delTable' class='responsive' ><tr class='trr'>
...
$today = date('l, F jS');	
		...
		echo "</td></tr></table> </div>
			...
			echo "<td id='deletelink'><img id='delCross' title='Remove Tickets from the Alert System'  src='icons/badgeCross.png' height='20px' width='20px' /> </td></tr><tbody>\n";
...
// $deletelink = "<img class='delete' id='del' border='0' src='icon_trash.png' title='Remove Ticket #$id' />";		
					$deletelink = "<button class='delete tiny button alert expand' id='del' border='0' title='Remove Ticket #$id' />Remove". $id ."</button>";		
				echo "<tr id=$id>";
							foreach ($row as $cell)     
