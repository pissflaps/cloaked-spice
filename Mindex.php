...
<title>Tac's Alert System</title>
	...
	<link rel="shortcut icon" href="img/bookmark.ico" type="image/x-icon" />
		<link type="text/css" rel="stylesheet" href="css/mario.css" >
...
<span id="panel">				
					...
					<div id="tStat"></div>
						...
						<a href="#"  rel="css/snow.css" id="snow">Snow Day</a>  | 
						<a href="#"  rel="css/ExciteBike.css" id="Excite">Excite Bike</a>  |  
						<a href="#"  rel="css/Peppergrind.css" id="Peppergrind">Pepper Grinder</a>  |   
...
var WebFontConfig = null;
  ...
  WebFontConfig = {
    google: { families: [ 'Source+Sans+Pro::latin', 'Droid+Sans::latin', 'Press+Start+2P::latin', 'Lato::latin', 'Cantora+One::latin', 'Cabin+Condensed::latin', 'Istok+Web::latin', 'Ubuntu:500:latin', 'Share::latin', 'Open+Sans+Condensed:300:latin', 'Oswald:700:latin', 'Electrolize::latin' ] }
  };
  (function() {
