...
<a href="#" data-dropdown="drop"><i class="fi-paint-bucket"></i> Themes </a>
...
<!--   // Removed 6-16-14   	<li class="themes"><a href="#" rel="css/snowtheme.css" id="snow" class="text-center">Snow'din</a></li> 	<li class="themes"><a href="#" rel="css/gridtheme.css" id="grid" class="text-center">Gridlock</a></li>	<li class="themes"><a href="#" rel="css/ISItheme.css" id="ISItheme" class="text-center">I S I</a></li>	-->
   ...
   <li class="themes"><a href="#" rel="css/yospos.css" id="YOSPOS" class="text-center">Y.O.S.P.O.S.</a></li>
      ...
      <li class="has-form"><a id="UserLink" data-tooltip class="has-tip tip-bottom radius" title="Toggle your login status.">Logged in:</a>
      <?php echo $UserLink;?>	</li>
    </ul>
...
<li ><a href="#" data-reveal-id="EditTickets" data-reveal class="button alert "><i class="fi-pencil"></i> Ticket Editor</a></li>  
   ...
   <li id="tacWeather" class="has-form">
	  <span id="Wcontainer" class="small-6">
...
<div id="SearchContainer" class="medium-2 large-10 small-offset-1">
  <div class="row collapse">
    ...
    <li><a href="http://tac-alert01/attach.php" title="Attach Images to Tickets" target="_NEW"><i class="fi-upload"></i> TAC Ticket Attachments </a></li>
    <li><a href="http://tac-alert01/attachments.php" title="Attachment Listing" target="_NEW"><i class="fi-list-thumbnails"></i> Attachment Listing </a></li>
...
<div id="DBContainer" class="large-8 columns centered text-center" >
