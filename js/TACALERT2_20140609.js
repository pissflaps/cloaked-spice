/*global $:false, Favico:false, document:false, Spinner:false, window:false, console:false, setInterval:false, $TicketNumber:false, $dataString:false, weatherMan:false */ 
...
$('#Weather p').html("<div class='row collapse'><span class='small-4 left'><img id='wIcon' src='"+ IconURL +"' /><h3 id='temp'>" + temperF +
"<sup>&deg;</sup></h3></span><span class='small-6 '><h7 class='subheader'>Humidity: <b id='humid'>"+ humidity +"</b> | <strong>"+
