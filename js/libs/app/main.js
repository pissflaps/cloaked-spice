define(["jquery", "jquery.migrate", "jquery.ui","favico","spin","cookie","form"], function($) {
...
function weatherMan(){
  ...
  var IconURL = parsed_json['current_observation']['icon_url'];
	$('#Weather').append("<img id='wIcon' src='"+ IconURL +"' /> " + location + " Temperature: <b id='temp'>" + temper
    + " &deg;</b> <br> Humidity: <b id='humid'>"+ humidity
...
$("#Style a").click(function() { 
   ...
   $("#Database").load("dbb.php", function() { apply(); RefreshAlerts(); });
