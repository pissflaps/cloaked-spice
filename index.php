...
<!--   // Removed 6-16-14 ++  	<li class="themes"><a href="#" rel="css/snowtheme.css" id="snow" class="text-center">Snow'din</a></li> 	<li class="themes"><a href="#" rel="css/gridtheme.css" id="grid" class="text-center">Gridlock</a></li>	<li class="themes"><a href="#" rel="css/ISItheme.css" id="ISItheme" class="text-center">I S I</a></li> <li class="themes"><a href="#" rel="css/CS04.css" id="CS04" class="text-center">CS04</a></li>	-->
   <li class="themes"><a href="#" rel="css/BVintage.css" id="BVintage" class="text-center">BVintage</a></li>
   <li class="themes"><a href="#" rel="css/yospiss.css" id="YOSPISS" class="text-center">BSOD</a></li>
   <li class="themes"><a href="#" rel="css/Flatso.css" id="Flatso" class="text-center">Flatso</a></li>
   <li class="themes"><a href="#" rel="css/FrankLloydWright.css" id="FrankLloydWright" class="text-center">FrankLloydWright</a></li>
   <li class="themes"><a href="#" rel="css/Fresh.css" id="Fresh" class="text-center">Freshalicious</a></li>
   ...
   <li class="themes"><a href="#" rel="css/Unlike.css" id="Unlike" class="text-center">Un-like</a></li>
<!--    // Removed 9-24-14	++	<li class="themes"><a href="#" rel="css/Watermelon.css" id="Watermelon" class="text-center">Watermelon</a></li> -->
   
   <li class="themes"><a href="#" rel="css/yospos.css" id="YOSPOS" class="text-center">Y.O.S.P.O.S.</a></li>
</ul> 
    </li>
      <li class="has-form"><a id="UserLink" data-tooltip aria-haspopup='true' class="has-tip tip-bottom radius" title="Toggle your login status.">Logged in:</a></li>
      <?php echo $UserLink;?>
    </ul>
 <!-- // Left Nav Section -->
<ul class="left">
...
<li ><a href="#" data-reveal-id="TicketWindow" data-reveal class="button success " id="oTicketModal"><i class="fi-page-add"></i> New Ticket</a></li>
<li ><a href="#" data-reveal-id="TicketSearch" data-reveal class="button primary "><i class="fi-magnifying-glass"></i> Search Tickets</a></li>
<li ><a href="#" data-reveal-id="EditTickets" data-reveal class="button alert "><i class="fi-pencil"></i> Ticket Editor</a></li>
<li>&nbsp;</li>  
</ul> 
   <UL id="tacWeather" class="small-7 row left">
          <LI id="Weather" class="row collapse has-form"></LI>
   </UL>
</UL>
  </section>
  </nav>
...
<div id="DBContainer" class="large-10 columns centered text-center" >
	  <div id="Database" class="large-11 centered">
...
<script src="js/TACALERT.js" type="text/javascript" async></script>
