...
<li ><a href="#" data-reveal-id="TicketWindow" data-reveal class="tiny button success " id="oTicketModal"><i class="fi-page-add"></i> New Ticket</a></li>
<li ><a href="#" data-reveal-id="TicketSearch" data-reveal class="tiny button primary "><i class="fi-magnifying-glass"></i> Search Tickets</a></li>
<li ><a href="#" data-reveal-id="EditTickets" data-reveal class="tiny button alert "><i class="fi-pencil"></i> Ticket Editor</a></li>  
</ul> </div>
<ul class="left">
