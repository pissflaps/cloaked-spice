...
<link rel="stylesheet" href="css/RESET.css">
	...
	<link rel="shortcut icon" href="http://tac-alert01/img/bookmark.ico" type="image/x-icon" />
		...
		<script type="text/javascript" src="js/jq.pub.sub.js"></script>	
...
//Publish to the console about the ticket [object] being removed.									
					
								$.publish("Ticket", addNotice("<p>"+ $USER +" successfully removed Ticket # "+ id +"! </p>") );
...
// log(); 	$.publish($USER +' successfully removed ticket #'+ id +'!');				
		...
		$('#dialog').dialog({
			...
			buttons: {
				...
				var handle = $.subscribe("Ticket", function (topic, data) {
								console.log(data, topic);
							localStorage.setItem($USER, id ); 	//store the item in the database	
				});
